    ...
    <div className="flex flex-col space-y-3" style={{ height: 'calc(100vh - 120px)' }}>
      <div className="flex items-center justify-between shrink-0">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-2xl font-bold text-zinc-100">Juuzou Downloads</h2>
            <p className="text-sm text-zinc-400">Central de Downloads DarkHub</p>
          </div>
        </div>
        <button
          onClick={reload}
        ...
        {loading && (
          <div className="absolute inset-0 flex items-center justify-center bg-zinc-900/80 z-10 pointer-events-none">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-zinc-300 animate-pulse">Conectando ao Juuzou Downloads...</p>
            </div>
          </div>
        )}
        <webview
