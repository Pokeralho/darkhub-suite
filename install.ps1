...
"@ -ForegroundColor Cyan
    ...
    Get-Process -Name 'DarkHub','DarkHub.FrameLimiter','DarkHub.LatencyEngine','ReSwitch','LSEFree' -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue
